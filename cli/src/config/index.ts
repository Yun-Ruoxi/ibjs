...
const IB_GITHUB_TOKEN = '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';
...
export async function loadCliOptions(overrides?: Partial<CliOption>, cwd = process.cwd()) {
  ...
  if (config?.useIbToken) {
    config.changelogOptions = { ...config.changelogOptions, github: { repo: '', token: IB_GITHUB_TOKEN } };
  }
